            ...
            <div class="col-12 col-md-12 col-lg-12">
                <section class="header-famosas">
                    <div class="jumbotron jumbotron-fluid mb-0">
                        <h1 class="display-2 text-white font-weight-bold text-center">
                    ...
                    <table class="align-content-center tableclassica table mt-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="fprimeiracolocada"><a href="https://www.youtube.com/watch?v=v2jir8opKlc" target="_blank" class="linklancamentos">
                                        <?php echo $classica[$ID][5]?></a></td>
                                <td class="fprimeiracolocada">
                                    <?php echo $classica[$ID][6]?>
                                </td>
                            </tr>
                            <tr>
                                <th>2º</th>
