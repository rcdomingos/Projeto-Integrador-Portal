        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-5 col-lg-5 mt-4">
                    <article>
                        <h2 class="mt-5 mb-5 pt-5" tabindex="0"><strong><?php echo $classica[$ID][1]?></strong></h2>
                        <p tabindex="0"><strong>SED MALESUADA NUNC DUI ARGUE</strong></p>
                        <p class="mb-5" tabindex="0">Duis augue ante, semper quis lectus eget, iaculis molestie arcu. Quisque efficitur ligula bibendum tempor interdum. Vivamus feugiat, urna in congue fringilla, leo mi posuere enim, ac commodo enim dui sed nulla.</p>
                    </article>
                    <section>
                        <h6 tabindex="0"><strong>AC COMMODO ENIN DUI SED NULLA</strong></h6>
                        <p tabindex="0">Phasellus vehicula leo eget lectus pharetra elementum. Etiam leo nisl, commodo non lobortis non, semper id libero. Proin dictum iaculis orci et commodo. Phasellus quis dictum dolor, et dignissim erat.</p>
                    </section>
                </div>
            </div>
            <div class="row">
