<?php
    ...
    $classica_es = array("Historia: Todo lo que no sabía acerca de la música clásica","Un lugar muy grande de construcción de lujo tiene varios sillones y luces. Es el lugar donde ocurren los conciertos musicales","El origen","Varias hojas de partituras siendo revestidas","Volver al principio");
        ...
        <div class="container mb-4">
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="text-center" tabindex="0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec convallis viverra scelerisque. Vivamus in ipsum quis turpis laoreet.</p>
                </div>
            </div>
            <div class="row">
