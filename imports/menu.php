...
<?php
$menu_pt = array("Home", "Noticias", "Ranking", "Cifras", "Indicações", "Quem Somos", "Contato", "Normas do Site", "Páginas", "Idioma:", "Selecione o idioma:", "Pular para conteúdo principal","Logo do site Ecletic.Music. No logo, dois raios então envolta de uma palheta. No meio da palheta as iniciais E e M, que significa Ecletic.Music");
$menu_en = array("Home", "News", "Ranking", "Chords", "Indications", "About Us", "Contact", "Site Rules", "Pages", "Language:", "Select the language:","Skip to main content", "Logo of the site Eclectic.Music. In the logo, two rays then wrapped in a pick. In the middle of the vane the initials E and M, which means Ecletic.Music.");
$menu_es = array("Home", "Noticias", "Clasificación", "Cifras musicales", "Indicaciones", "Sobre nosotros", "Contacto", "Normas", "páginas", "Idioma:", "Seleccione el idioma:", "Saltar al contenido principal", "Logo del sitio Eclectic.Music. No logo, dos rayos luego envueltos en un pico. En el medio de la veleta las iniciales E y M, que significa Ecletic.Music");
        ...
        <div class="row">
            <div class="col-6 text-center">
                <a class="navbar-brand" href="./">
                    <img src="images/principal/LOGO.svg" width="40" height="40" class="d-inline-block align-center" alt="<?php echo $menu[$ID][12] ?>"> Ecletic.Music </a>
            </div>
            ...
            <div id="redes-sociais" class="col-3 order-last align-top">
                <span class="sr-only" tabindex="0">Siga-nos nas redes sociais</span>
                <ul id="siga-desk">
                    ...
                    <li class="insta"> <a href="https://www.instagram.com/" target="_blank" rel="noopener" aria-label="Instagran"><i class="fab fa-instagram"></i></a></li>
