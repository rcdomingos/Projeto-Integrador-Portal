...
<div id="skippy">
  <a class="sr-only sr-only-focusable" href="#navprincipal">
    <div class="container">
      <span class="skiplink-text">Voltar ao menu </span>
    </div>
  </a>
</div>
<footer id="footer">
            ...
            <div class="col-8 col-lg-3 pb-3 pb-sm-0">
              <nav class="menu-secundario">
                <ul class="nav flex-column pl-xs-3">
                  ...
                  <li class="nav-item">
                    <a class="nav-link dropdown-toggle" data-toggle="collapse" href="#conteudosite" role="button" aria-expanded="false" aria-controls="conteudosite"><?php echo $menu[$ID][8] ?></a>
