        ...
        <section class="container">
            <div class="row p-3">
                <div class="card text-white p-0">
                    ...
                    <img class="card-img shadow" src="../images/indie/criolo.jpg" alt="Foto do busto do cantor Criolo usando um moletom camuflado com o capus cobrindo a cabeça olhando para frente ao fundo a cor amarela.">
                </div>
            </div>
        </section>
        ...
        <section class="container mt-4 mt-md-4 mt-lg-4 mt-xl-4 mb-5">
            <div class="row">
                <div class="text-white col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-4">
                    <div class="card-img-overlay">
                        <h5 class="card-title ml-3"><a href="https://www.instagram.com/emicida/" target="_blank" class="text-white"><u><?php echo $indie[$ID][4]; ?></u></a></h5>
                        <p class="card-text ml-3"><?php echo $indie[$ID][5]; ?></p>
                    </div>
                    <img class="card-img shadow" src="../images/indie/emicida.jpg" alt="Foto do cantor Emicida de óculos escuro camiseta preta e boné coçando a barba ao fundo a cor vermelha.">
                </div>

                <div class="text-white col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <div class="card-img-overlay">
                        <h5 class="card-title ml-3"><a href="https://www.instagram.com/floramatos/" target="_blank" class="text-white"><u><?php echo $indie[$ID][6]; ?></u></a></h5>
                        <p class="card-text ml-3"><?php echo $indie[$ID][7]; ?></p>
                    </div>
                    <img class="card-img shadow" src="../images/indie/flora.jpg" alt="Foto da cantora Flora Matos agachada usando uma blusa branca e rosa cheia de anéis e pulseiras segurando o queixo com a mão direita ao fundo a cor rosa.">
                </div>
            </div>
        </section>
        ...
        <section class="container mb-5">
            <section class="row text-center mb-3">
                <div class="col-lg-12">
                    ...
                    <blockquote class="blockquote mt-0"><small class="text-muted"><?php echo $indie[$ID][9]; ?></small></blockquote>
                </div>
            </section>
            ...
            <section class="row mt-3 mb-0">
                <div class="col-12">
                    <div class="card text-white">
                        <img class="card-img shadow" src="../images/indie/djonga.jpg" alt="Foto do cantor Djonga no video clip da música Favela Vive 3 vestido com um moletom e uma camiseta branca com o cabelo descolorido fazendo um sinal de ok com a mão esquera enquanto canta.">
                    </div>
                </div>    
            </section>
            ...
            <div class="row mt-0 mb-3">
                <div class="col-12">
                    <a href="https://www.instagram.com/djongador/" target="_blank" class="text-body"><u>Mais sobre o cantor.</u></a>
                </div>
            </div> 
